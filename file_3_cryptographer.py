...
b=['г','и','к','т','ч','ь','б','ж','л','р','х','ъ','я','д','й','о','у','ш','э','в','з','м','с','ц','ы','а','е','к','п','ф','щ','ю',' ']
text=''
stroka=''
print('1-зашифровать собщение')
print('2-расшифровать собщение')
mode=int(input('Введите режим работы: '))
with open('input_text_cipher.txt', 'r', encoding="utf-8") as file:
    for line in file:
        text=text+line
myfile_2=open('output_text_cipher.txt`','w')        
if mode==1:
    for item in text:
